...
@Getter
public class MovieWithFavoritedAndReview implements Movie {
    private Long id;
    ...
    public MovieWithFavoritedAndReview(MovieApiResponse movie, boolean favorited, List<ReviewCreationResponseDTO> reviews) {
        this.id = movie.getId();
